...
* Loaded data filtered conclusive rows: excluding 'inconclusive' and value = 28183.8 nM, n = 22326
...
* Computed correlation matrices between all numerical columns (Pearson and Spearman) and generated heatmaps
    ...
    * 'Standard value' and 'Molecule Max Phase' show a weak correlation (0.16). 'Molecule Max Phase' contains only 80 non-null values
    * Stronger correlations between '#RO5 Violations' and 'AlogP' (0.49) or 'Molecular Weight' (0.49). This is logical as logP and Molecular weight form part of the rule-of-5 (RO5)
...
* Violin plot of 'Standard Value' vs '#RO5 Violations' don't show any clear differences. Distribution of compounds with 0, 1 or 2 shows two peaks and long tails. With 3 violations the distribution is much flatter and wider.
    * A value_count shows that the group with 3 violations only contains 12 rows, therefore the change in distribution is likely a result of the small sample.